...
class TlsConfig(Config):
    ...
    def generate_config_section(
        ...
        **kwargs
        ...
        tls_enabled = (
            "" if tls_certificate_path and tls_private_key_path else "#"
        )
        ...
        # This certificate, as of Synapse 1.0, needs to be a valid and verifiable
    ...
    def read_tls_certificate(self):
        ...
        if cert.get_issuer() == cert.get_subject():
            warnings.warn(
                (
                    "Self-signed TLS certificates are not accepted as of Synapse 1.0. "
                    "Please either provide a valid certificate, or use a reverse proxy "
